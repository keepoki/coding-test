 ...
 * Explanation: 당신의 함수는 k = 2를 반환해야 하며, nums의 첫 두 요소는 2가 되어야
 * 합니다. 반환되는 k 이후의 요소들은 무엇이든 상관없습니다(그래서 밑줄로 표시했습니다).
 *
 * Example 2:
 * Input: nums = [0,1,2,2,3,0,4,2], val = 2
 * Output: 5, nums = [0,1,4,0,3,_,_,_]
 * Explanation: 당신의 함수는 k = 5를 반환해야 하며, nums의 첫 다섯 요소는
 ...
 *    right는 val과 다른 요소를 찾을 때까지 왼쪽으로 탐색한다.
 * 4. left와 right가 각각 조건에 맞는 요소를 찾았다면, 서로 데이터를 교환한다.
 * 5. 3번 과정을 left < right 조건에 부합할 때까지 이어나간다.
 *
 * 풀이 요약:
